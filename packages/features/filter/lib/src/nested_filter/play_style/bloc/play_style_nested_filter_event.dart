...
abstract class PlayStyleNestedFilterEvent with PlayStyleNestedFilterEventMappable {}
...
class SelectPlayStyle extends PlayStyleNestedFilterEvent with SelectPlayStyleMappable {
  SelectPlayStyle({
    required this.item,
  });
