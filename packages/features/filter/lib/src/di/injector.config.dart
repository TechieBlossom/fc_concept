...
import 'package:feature_filter/src/filter/bloc/filter_bloc.dart' as _i11;
import 'package:feature_filter/src/navigation/navigator.dart' as _i3;
import 'package:feature_filter/src/navigation/routes.dart' as _i5;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i3.FilterNavigator>(
      () => _i3.FilterNavigator(gh<_i4.GoRouter>()));
  gh.lazySingleton<_i5.FilterRoutesConfig>(() => _i5.FilterRoutesConfig());
  gh.factoryParam<_i6.NestedFilterBloc, _i7.NestedFilterPageParams, dynamic>((
    ...
    _,
      ...
      _i6.NestedFilterBloc(
        ...
        gh<_i3.FilterNavigator>(),
      ));
  gh.factoryParam<_i9.RarityNestedFilterBloc, _i10.RarityNestedFilterPageParams,
      dynamic>((
    rarityNestedFilterPageParams,
    _,
  ) =>
      _i9.RarityNestedFilterBloc(
        rarityNestedFilterPageParams,
        gh<_i8.GetAllRarities>(),
        gh<_i3.FilterNavigator>(),
      ));
  gh.factoryParam<_i11.FilterBloc, _i8.FilterConfiguration?, dynamic>((
    existingFilters,
    _,
  ) =>
      _i11.FilterBloc(
