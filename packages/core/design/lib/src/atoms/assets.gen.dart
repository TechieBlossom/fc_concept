...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/left_foot.svg
  SvgGenImage get leftFoot => const SvgGenImage('assets/icons/left_foot.svg');

  /// File path: assets/icons/right_foot.svg
  SvgGenImage get rightFoot => const SvgGenImage('assets/icons/right_foot.svg');

  /// List of all assets
  List<SvgGenImage> get values => [leftFoot, rightFoot];
}
...
class AssetGenImage {
  ...
  String get keyName => 'packages/core_design/$_assetName';
}
