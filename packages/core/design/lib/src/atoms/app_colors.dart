...
const surface = Color(0xFFFFFFFF); // backgroundPrimary
const secondaryContainer = Color(0xFF707070); //backgroundSecondary
const surfaceContainerHighest = Color(0xB3F4F4F4); //backgroundTertiary
const tertiaryContainer = Color(0x17C0A203); // backgroundFour
const primary = Color(0xFF2B2B2B); // contentSecondary

const secondary = Color(0xFF797979); // contentTertiary
const onTertiary = Color(0xFF000000); //contentPrimary
const tertiary = Color(0xFFE8DC9A); // gold
const outlineVariant = Color(0xFFC0A203); // gold2
const errorContainer = Color(0xFFEA6868); // red

const onErrorContainer = Color(0xFFFFFFFF); // Repeat
const onSecondaryContainer = Color(0xFFFFFFFF); // Repeat
const onPrimary = Color(0xFFFFFFFF); //Repeat
const onPrimaryContainer = Color(0xFFFFFFFF); // Not used, except for catalog
const outline = Color(0xFF000000); // Repeat
const onTertiaryContainer = Color(0xFF000000); // Repeat
const primaryContainer = Color(0xFF2B2B2B); // Not used
